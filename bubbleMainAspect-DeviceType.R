  ...
  fileName <- paste("../paper/figures/Bubble", "MainAspect-DeviceType", ".png", sep="")
  Var1Label <- ""
  Var2Label <- ""
  bubbleScaler <- 1.25
  ...
  Var2ColumnOldValues <- c("emulation", "smartphone", "tablet")
  Var2ColumnNewValues <- c("Emulation", "Smartphone", "Tablet")
