  ...
  Var2ColumnName <- "code_scope"
  fileName <- paste("../paper/figures/Bubble", "MainAspect-Scope", ".png", sep="")
  Var1Label <- ""
  Var2Label <- ""
  bubbleScaler <- 1.25
  ...
  Var2ColumnOldValues <- c("pageload", "usagescenarios", "both")
  Var2ColumnNewValues <- c("Page\nload", "Usage\nscenarios", "Both")
  
  # name of the X and Y axis labels
  xLabel <- "Main aspect"
  yLabel <- "Experiment scope"
  ...
  grid$Var2 <- factor(grid$Var2, levels = c("Both", "Usage\nscenarios", "Page\nload"))
