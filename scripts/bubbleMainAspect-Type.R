  ...
  Var2ColumnName <- "code_sitestype"
  fileName <- paste("../paper/figures/Bubble", "MainAspect-Type", ".png", sep="")
  Var1Label <- ""
  Var2Label <- ""
  bubbleScaler <- 1.25
  ...
  Var2ColumnOldValues <- c("real", "synthetic", "real, synthetic")
  Var2ColumnNewValues <- c("Real", "Synthetic", "Both")
  ...
  Var1 <- lapply(Elements1, function(vec) flatten_chr(strsplit(str_replace_all(vec, fixed(" "), ""), ",", perl = T)))
  Var1 <- unique(flatten_chr(Var1))
